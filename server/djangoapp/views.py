...
def get_dealer_details(request, dealer_id):
    context={}
    url = "https://eu-de.functions.appdomain.cloud/api/v1/web/IBM-Lab_CLI/dealership-package/get-review"
    apikey="Uc1J05vYEQcFigh7CXCT9-HhgJtYnk-akIFxchmqLNeC"
    #print(dealer_id)
    # Get dealers from the URL
...
def add_review(request, dealer_id):
    ...
    if request.method == 'GET':
        ...
        if (request.user.is_authenticated):
            ...
            json_result = post_request("https://eu-de.functions.appdomain.cloud/api/v1/web/IBM-Lab_CLI/dealership-package/post-review", review, dealerId=dealer_id)
            print(json_result)
